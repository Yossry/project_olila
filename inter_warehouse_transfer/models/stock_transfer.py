...
class StockTransfer(models.Model):
    ...
    _description = 'Inter Warehouse Stock Transfer'
    ...
    def create(self, vals):
        code = self.env['ir.sequence'].next_by_code('inter.warehouse.transfer')
        vals['name'] = code
    ...
    def action_process(self):
        ...
        transit_location = self.env.ref('inter_warehouse_transfer.inter_warehouse_stock_location')
...
class StockTransferLine(models.Model):
    ...
    _description = 'Inter Warehouse Stock Transfer Line'
