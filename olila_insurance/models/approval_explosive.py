...
class PreApprovalExplosiveLine(models.Model):
    ...
    importable_quantity = fields.Float(string='Importable Quantity')
    stock_before_approval = fields.Float(string='Stock Before Approval')
    applic_quantity = fields.Float(string='Quantity')
    ...
    import_quantity = fields.Float(string='Import Quantity')  
